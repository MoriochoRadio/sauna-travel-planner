/**
 * 여행 가이드 — 코스 생성과 별개로, "어떻게 쉬어야 하는지"를 문장으로 안내한다.
 * placeIds는 src/data/verified.ts의 검증 큐레이션 장소를 가리킨다.
 *
...
export const travelGuides: TravelGuide[] = [
  {
    ...
    placeIds: ["busan-spa-verified-01", "busan-spa-verified-02"],
  ...
  },
  {
    ...
    placeIds: ["busan-spa-verified-02", "chungnam-spa-verified-01"],
  ...
  },
  {
    ...
    placeIds: ["gyeongbuk-spa-verified-01", "gangwon-spa-verified-01"],
