// 전국 시군구 명칭 (행정표준코드 기준, 2024년 기준)
// [시도코드, 시도명, 시군구명[]]
// 좌표는 scripts/build-sigungu.mjs 가 카카오 주소검색으로 자동 수집
export const REGION_SIGUNGU: [string, string, string[]][] = [
  ["seoul", "서울", [
...
// tourAPI areaCode (시도코드, tourAPI 자체 값)
export const REGION_TOURAPI_CODE: Record<string, string> = {
  seoul: "1", incheon: "2", daejeon: "3", daegu: "4", gwangju: "5", busan: "6",
  ulsan: "7", sejong: "8", gyeonggi: "31", gangwon: "32", chungbuk: "33",
  chungnam: "34", gyeongbuk: "35", gyeongnam: "36", jeonbuk: "37", jeonnam: "38", jeju: "39",
};
