...
export const regions: RegionData[] = [
  {
    ...
    places: mergeRegionPlaces([
      { id: "seoul-lodging-01", name: "강남 온천 호텔(스파)", type: "lodging", region: "seoul", city: "서울 강남구", summary: "사우나 겸 온천 스파를 갖춘 도심 호텔", tags: ['프리미엄', '온천', '야간'], priceLevel: "mid", avgDurationMin: 480, openHours: "24시간", highlights: ['노천 온천', '사우나'], source: "curated", hasOnsen: true, hasSauna: true },
  ...
  },
  {
    ...
    onsenDistrict: false,
    places: mergeRegionPlaces([
      { id: "busan-lodging-01", name: "해운대 온천 리조트", type: "lodging", region: "busan", city: "부산 해운대구", summary: "바다 앞 노천온천을 갖춘 리조텔", tags: ['해변', '온천', '가족'], priceLevel: "mid", avgDurationMin: 480, openHours: "24시간", highlights: ['노천탕', '사우나'], source: "curated", hasOnsen: true, hasSauna: true },
  ...
  },
  {
    ...
    onsenDistrict: true,
    places: mergeRegionPlaces([
      { id: "gangwon-lodging-01", name: "평창 온천 콘도", type: "lodging", region: "gangwon", city: "강원 평창군", summary: "슬로프 근처 온천 콘도, 사우나 완비", tags: ['야외온천', '설경', '가족'], priceLevel: "mid", avgDurationMin: 480, openHours: "24시간", highlights: ['노천탕', '한증막'], source: "curated", hasOnsen: true, hasSauna: true },
  ...
  },
  {
    ...
    onsenDistrict: true,
    places: mergeRegionPlaces([
      { id: "gyeongju-lodging-01", name: "보문 온천 호텔", type: "lodging", region: "gyeongju", city: "경북 경주시", summary: "호수 앞 온천 호텔, 한식 레스토랑", tags: ['온천', '호수', '프리미엄'], priceLevel: "mid", avgDurationMin: 480, openHours: "24시간", highlights: ['실내 온천', '사우나'], source: "curated", hasOnsen: true, hasSauna: true },
  ...
  },
  {
    ...
    onsenDistrict: false,
    places: mergeRegionPlaces([
      { id: "jeju-lodging-01", name: "제주 온천 풀빌라", type: "lodging", region: "jeju", city: "제주 제주시", summary: "개인 온천이 있는 풀빌라", tags: ['온천', '프리미엄', '야외온천'], priceLevel: "mid", avgDurationMin: 480, openHours: "24시간", highlights: ['프라이빗 온천'], source: "curated", hasOnsen: true, hasSauna: false },
  ...
  },
  {
    ...
    onsenDistrict: false,
    places: mergeRegionPlaces([
      { id: "incheon-lodging-01", name: "송도 온천 비즈니스 호텔", type: "lodging", region: "incheon", city: "인천 송도구", summary: "사우나를 갖춘 비즈니스 호텔", tags: ['가성비', '사우나'], priceLevel: "mid", avgDurationMin: 480, openHours: "24시간", highlights: ['사우나', '수면실'], source: "curated", hasOnsen: false, hasSauna: true },
  ...
  },
  {
    ...
    onsenDistrict: false,
    places: mergeRegionPlaces([
      { id: "daejeon-lodging-01", name: "유성 온천 호텔", type: "lodging", region: "daejeon", city: "대전 유성구", summary: "유명 유성 온천을 갖춘 호텔", tags: ['온천', '보양'], priceLevel: "mid", avgDurationMin: 480, openHours: "24시간", highlights: ['노천 온천'], source: "curated", hasOnsen: true, hasSauna: true },
  ...
  },
  {
    ...
    onsenDistrict: false,
    places: mergeRegionPlaces([
      { id: "gwangju-lodging-01", name: "무등산 온천 호텔", type: "lodging", region: "gwangju", city: "광주 동구", summary: "무등산 기슭 온천 호텔", tags: ['온천', '조용한'], priceLevel: "mid", avgDurationMin: 480, openHours: "24시간", highlights: ['실내 온천'], source: "curated", hasOnsen: true, hasSauna: false },
  ...
  },
  {
    ...
    onsenDistrict: false,
    places: mergeRegionPlaces([
      { id: "daegu-lodging-01", name: "스파밸리 리조트", type: "lodging", region: "daegu", city: "대구 달서구", summary: "대규모 스파 리조트 숙박", tags: ['야외온천', '가족', '프리미엄'], priceLevel: "mid", avgDurationMin: 480, openHours: "24시간", highlights: ['워터파크', '사우나'], source: "curated", hasOnsen: true, hasSauna: true },
